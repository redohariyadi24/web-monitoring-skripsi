...
@section('main')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Bimbingan/</span> Tambah Data Bimbingan</h4>
    ...
    <div class="col-xl mx-auto" style="max-width: 700px">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('bimbingan-admin.simpan') }}" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="mb-3">
                        <div class="form-floating">
                            <input name="nama" type="text" class="form-control" id="floatingInput"
                                placeholder="Bimbingan" value="Bimbingan " aria-describedby="floatingInputHelp" />
