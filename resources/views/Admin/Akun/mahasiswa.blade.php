            ...
            <div class="dt-action-buttons text-end pt-3 pt-md-0 ms-md-auto">
                <div class="dt-buttons">
                    <button class="dt-button create-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0"
                        type="button" onclick="window.location.href='{{ route('mahasiswa.tambah') }}'">
                        <span>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('mahasiswa.edit', ['role' => 'mahasiswa', 'id' => $akun->id]) }}">
                                            <i class="bx bx-edit-alt me-1"></i> Edit
                                        </a>
                                        <form id="formHapusMahasiswa" action="{{ route('mahasiswa.hapus', ['id' => $akun->id]) }}" method="POST"
