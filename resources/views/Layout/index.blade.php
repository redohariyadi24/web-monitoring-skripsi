...
{% block styles %}
<link rel="stylesheet" href="{{ asset('import/assets/scss/iconly.scss') }}">
{% endblock %}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset('assets/static/images/faces/8.jpg') }}">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset('assets/static/images/faces/3.jpg') }}">
                                                    </div>
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ asset('assets/static/images/faces/4.jpg') }}">
                        </div>
                        <div class="name ms-4">
